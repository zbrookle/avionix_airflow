...
conda remove --all -q -y -n avionix_airflow

echo
echo "conda create -n avionix_airflow python=3.7 -y"
time conda create -n avionix_airflow python=3.7 -y
